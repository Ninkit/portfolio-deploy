...
const Services = () => {
    return (
        <section className="container mx-auto min-h-[80vh] flex flex-col justify-center py-12 xl:py-0">
            <div>
                <motion.div 
                initial={{opacity: 0}} 
                animate={{
                ...
                {services.map((service, index)=>{
                    ...
                    className="flex flex-1 flex-col justify-center gap-6 group">
                        ...
                        <div className="w-full flex justify-between items-center">
                            ...
                            <Link href={service.href} className="w-[78px] h-[70px] rounded-full
                            bg-white group-hover:bg-accent transition-all flex justify-center
